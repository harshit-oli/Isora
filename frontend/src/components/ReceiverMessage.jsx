...
const ReceiverMessage = ({message}) => {
  ...
  return (
    <div ref={scroll} className='w-fit max-w-[60%] bg-gradient-to-br from-[#4d4653] to-[#97808e] rounded-2xl rounded-br-2xl rounded-bl-0 px-[10px] py-[10px] relative left-0 flex flex-col gap-[10px]'>
      ...
      <div className='w-[30px] h-[30px] rounded-full cursor-pointer overflow-hidden absolute left-[-25px] bottom-[-40px]'>
        <img src={selectedUser?.profileImage || logo2 } alt="" className='w-full object-cover' />
      </div>
    </div>
  )
}
